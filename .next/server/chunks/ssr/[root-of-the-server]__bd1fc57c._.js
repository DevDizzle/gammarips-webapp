...
"[project]/src/lib/data:6ca375 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-toast.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$6ca375__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:6ca375 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
    ...
    const linkAnonymousAccount = async (credential)=>{
        if (auth.currentUser && auth.currentUser.isAnonymous) {
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$6ca375__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getOrCreateUserAdmin"])(result.user.uid, false, result.user.displayName || undefined, result.user.email || undefined);
                toast({
    ...
    const signUpWithEmail = async (email, password)=>{
        try {
            if (auth.currentUser && auth.currentUser.isAnonymous) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$6ca375__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getOrCreateUserAdmin"])(userCredential.user.uid, false, userCredential.user.displayName || undefined, userCredential.user.email || undefined);
            }
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bd1fc57c._.js.map