...
const UserSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    createdAt: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].any(),
    ...
    const linkAnonymousAccount = async (credential)=>{
        if (auth.currentUser && auth.currentUser.isAnonymous) {
            try {
                ...
                setUser(result.user);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrCreateUser"])(result.user.uid, false, result.user.displayName || undefined, result.user.email || undefined);
                toast({
    ...
    const signUpWithEmail = async (email, password)=>{
        try {
            if (auth.currentUser && auth.currentUser.isAnonymous) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrCreateUser"])(newUser.uid, false, newUser.displayName || undefined, newUser.email || undefined);
            } else {
                const userCredential = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$8e6e89cb$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__["createUserWithEmailAndPassword"])(auth, email, password);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getOrCreateUser"])(userCredential.user.uid, false, userCredential.user.displayName || undefined, userCredential.user.email || undefined);
            }
        } catch (error) {
