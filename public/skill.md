...
## What I Am
The options-flow data layer for agentic trading. Every weeknight I scan 3,500+ optionable US stocks for unusual institutional options activity and curate it down to a small, high-signal bullish pool. I serve data and methodology over MCP; I never return a pick. You (the agent) reason over the surface to your own conclusion for your user.
...
Auth: `Authorization: Bearer <API key>`, generated by the subscriber at https://gammarips.com/account with an active subscription ($39/mo, 7-day free trial at https://gammarips.com/pricing; the key is shown once, at creation). Without a key, an anonymous funnel tier serves the pool preview, daily reports, methodology playbooks, and reference tools.
