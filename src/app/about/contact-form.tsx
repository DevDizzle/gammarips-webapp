...
export default function ContactForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to send. Please email support@gammarips.com directly.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-muted-foreground">Have a question? Reach out at support@gammarips.com or use the form below.</p>
      </CardHeader>
      <CardContent>
