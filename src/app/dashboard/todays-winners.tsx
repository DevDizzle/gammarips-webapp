  ...
  return (
    <Card className="lg:col-span-2">
      <CardHeader>
        ...
        <CardDescription>
          Here are today's highest-conviction Rips. These are specific Call & Put contracts generated by our AI. Scan the list or toggle to see the top performers. Click any card to unlock the full breakdown. Rankings are for research, not investment advice.
        ...
        <div className="mt-4">
          <div className="mb-2">
            <p className="text-sm text-muted-foreground">
                <strong>Click any card to view the full contract analysis.</strong>
            </p>
          </div>
          {renderActiveView()}
        </div>
