...
const disclosures = [
  {
    ...
    body: [
      "Every V5.4 pick is paper-traded. There is no brokerage account behind these signals, no real capital at risk on any signal we publish, and no order ever hits a real exchange via GammaRips.",
      "The forward paper-trading ledger is a forward simulator: it ingests Polygon end-of-day options data, applies the V5.4 entry and exit rules at the same timestamps a live trader would, and records the outcome. The same data feeds the public scorecard.",
  ...
  },
  {
    ...
    body: [
      "The V5.4 strategy went live on the forward paper-trader on April 17, 2026. Until the V5.4 ledger has 30 closed paper trades, GammaRips does not publish or market any aggregate performance number — no win rate, no Sharpe ratio, no expectancy claim, no \"we returned X%.\"",
  ...
  },
  {
    ...
    body: [
      ...
      "Market regimes change. A strategy that worked in one volatility environment can fail in another. The 2026-Q1/Q2 regime that V5.4 is being tested in is not necessarily the regime you will trade in if you act on these signals later.",
      "There is no claim, express or implied, that any past V5.4 paper-trade outcome is indicative of any future result, paper or live.",
    ],
  },
  {
    icon: UserX,
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 text-sm">
            <li>
              ...
              — every threshold, every data source, every tiebreaker behind a V5.4 pick.
            </li>
            <li>
