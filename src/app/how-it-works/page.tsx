...
export const metadata: Metadata = {
  ...
  description:
    "The full pipeline: overnight flow across about 3,500 optionable US stocks, an enrichment bar, a bullish-only gate, and a delta edge-rank down to about 50 setups.",
  alternates: { canonical: 'https://gammarips.com/how-it-works' },
  openGraph: {
    images: [OG_IMAGE],
    title: 'How GammaRips Works | Overnight Options Scanner',
    description: 'Scanned, enriched, curated: about 3,500 optionable US stocks cut to a high-signal bullish pool nightly, validated by a public paper-traded cohort.',
    ...
    <section className="container mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <header className="text-center">
        ...
        <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
          Every night the engine scans about 3,500 optionable US stocks for unusual options flow and curates the firehose down to a small bullish pool: scored, enriched, and checked for hindsight data while you sleep. Here&apos;s the full pipeline, end to end.
        </p>
      </header>
      ...
      <section className="space-y-4">
        ...
        <p className="text-muted-foreground leading-relaxed">
          GammaRips tracks this across about 3,500 optionable US stocks every night, then curates them to the strongest ~50 setups, the pool your agent reasons over.
        </p>
      </section>
