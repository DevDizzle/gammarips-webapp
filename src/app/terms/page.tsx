...
export default function TermsPage() {
  return (
    <article className="prose prose-invert">
      ...
      <p>Welcome to ProfitScout (“ProfitScout,” “we,” “our,” or “us”). These Terms of Service (“Terms”) govern your access to and use of our website, applications, APIs, data feeds, and any related services (collectively, the “Service”). By using the Service, you agree to these Terms.</p>
      ...
      <p>ProfitScout provides AI-generated and data-driven research for equities and options. Content is for informational and educational purposes only and is not investment, financial, legal, tax, or trading advice. You are solely responsible for any decisions you make using the Service.</p>

      <h2>3) API &amp; Actions License</h2>
      <p>If you access ProfitScout programmatically (e.g., via our HTTP endpoints or ChatGPT Actions):</p>
      <ul>
        ...
        <li><strong>Attribution.</strong> When our data is rendered in downstream experiences, display: “Source: ProfitScout.”</li>
      ...
      <p>ProfitScout is not a broker, dealer, investment adviser, or fiduciary. The Service does not perform individualized suitability analysis. All decisions are your own and undertaken at your own risk.</p>
      ...
      <p>TO THE MAXIMUM EXTENT PERMITTED BY LAW, NEITHER PROFITSCOUNT NOR ITS SUPPLIERS OR LICENSORS WILL BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES; LOSS OF PROFITS, REVENUE, DATA, OR GOODWILL; OR BUSINESS INTERRUPTION—EVEN IF ADVISED OF THE POSSIBILITY. OUR AGGREGATE LIABILITY FOR ALL CLAIMS RELATING TO THE SERVICE WILL NOT EXCEED THE AMOUNT PAID BY YOU TO US FOR THE SERVICE IN THE 12 MONTHS BEFORE THE EVENT GIVING RISE TO LIABILITY.</p>
      ...
      <p><strong>Informal Resolution First.</strong> Before filing a claim, you agree to email us at legal@profitscout.app with “Dispute Notice” in the subject line and a brief description of your Dispute. If we cannot resolve it within 30 days, either party may proceed as set out below.</p>
      ...
      <ul>
        ...
        <li><strong>Fees.</strong> AAA fees are governed by the applicable AAA Rules. For individual consumers, ProfitScout will reimburse filing fees above $200 upon request after you participate in the informal resolution step.</li>
      ...
      <p><strong>Opt-Out.</strong> You may opt out of arbitration within 30 days of first accepting these Terms by emailing admin@profitscout.app with your full name, the email tied to your account, and a clear statement that you wish to opt out of the arbitration agreement. Opting out does not affect other provisions of these Terms.</p>
      ...
      <h2>18) Contact</h2>
      <p>Questions about these Terms? Email <a href="mailto:admin@profitscout.app">admin@profitscout.app</a>.</p>
      <p>
        ProfitScout<br />
