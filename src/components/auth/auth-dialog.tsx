      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
             {isSignIn
                ? 'Welcome back.'
                : 'Sign up free to see today\'s V5.4 pick at 07:30 ET, browse the full signals list, and read the daily report. Upgrade to Pro anytime for the WhatsApp push and chat agent.'
             }
          </DialogDescription>
        </DialogHeader>
