  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-[11px] text-muted-foreground text-center leading-tight">
        ...
        fixed same-day bracket; it loses on purpose-built honesty, and it&apos;s why the
        exit is your agent&apos;s job. Peaks/drawdowns are realized excursions per
        contract (what was actually possible), not returns anyone earned.
      </p>
    </div>
  );
}
