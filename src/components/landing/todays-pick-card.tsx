...
const SKIP_REASON_COPY: Record<string, string> = {
  no_candidates_passed_gates:
    "No signals cleared today's V5.3 filter stack (V/OI > 2, 5–15% OTM, VIX ≤ VIX3M). On these days the engine stays out — routine over FOMO.",
  regime_fail_closed:
    "Regime data was unavailable (VIX or VIX3M missing). Fail-closed: no trade today.",
  vix_backwardation:
    "VIX closed above VIX3M today. Backwardation regime — the engine skips these days because premium-selling setups fail disproportionately here.",
};
          ...
          <div className="pt-4 border-t border-border">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {pick.moneyness_pct !== undefined && (
                <Badge variant="secondary" className="text-xs">
                  {(pick.moneyness_pct * 100).toFixed(1)}% OTM (5–15%) ✓
                </Badge>
              )}
